...
const HOJAS = [
  ...
  /* ⚠⚠ ESTA FILA CAZÓ UN DEFECTO REAL el 2026-09-08. La hoja se rediseñó a evento de DESOVE
     ...
     que es el fallo silencioso que deja la vista VACÍA sin un solo error. Lo destapó actualizar
     este fixture a la hoja de verdad; con el fixture viejo describiendo columnas que ya no
  ...
  ['Maduración Tanques', 'Maduracion', ['Fecha', 'Sala', 'Lote', 'Tanque', 'Población inicial hembras', 'Población inicial machos', 'Machos muertos', 'Hembras muertas', 'Machos muertos por descarte de selección', 'Hembras muertas por descarte de selección', 'Cópulas', 'Muda', 'Peso promedio machos (g)', 'Peso promedio hembras (g)', 'Observaciones sanitarias']],
